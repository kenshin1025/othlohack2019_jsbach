<template>
    <div>
        ...
        <draggable
                ...
                :options="options"
        >
            <div :class="set_width(item.notes)" v-for="(item, i) in itemsChord" :key="i">
                <BeatPieces
                        class="beatPiece"
        ...
        <draggable
                ...
                :options="options"
        >
            <div :class="set_width(item.notes)" v-for="(item, i) in itemsOHihat" :key="i">
                <BeatPieces
                        class="beatPiece"
                        :class="set_width(item.notes)"
                        :notes="item.notes"
                        :beatType="item.type"
                        :items=itemsOHihat
                        :now_beats="now_beats"
        ...
        <draggable
                ...
                :options="options"
        >
            <div :class="set_width(item.notes)" v-for="(item, i) in itemsCHihat" :key="i">
                <BeatPieces
                        class="beatPiece"
                        :class="set_width(item.notes)"
                        :notes="item.notes"
        ...
        <draggable
                ...
                :options="options"
        >
            <div :class="set_width(item.notes)" v-for="(item, i) in itemsSnare" :key="i">
                <BeatPieces
                        class="beatPiece"
                        :class="set_width(item.notes)"
                        :notes="item.notes"
        ...
        <draggable
                ...
                :options="options"
        >
            <div :class="set_width(item.notes)" v-for="(item, i) in itemsKick" :key="i">
                <BeatPieces
                        class="beatPiece"
                        :notes="item.notes"
                        :beatType="item.type"
...
<script>
    ...
    export default {
        ...
        methods: {
            set_width(notes) {
                return {
                    node2: notes.length === 2,
                    node4: notes.length === 4,
                    node8: notes.length === 8
                };
            },
